/** for routing examples see:
 *
 *  http://plnkr.co/edit/mXSjnUtN7CM6ZqtOicE2?p=preview
 *  http://plnkr.co/edit/TU73YA7kD7ZMyD8wEsUd?p=preview
 *
 **/
...
const appRoutes: Routes = [{
    ...
    children: [{
        ...
        path: 'Logout',
        component: Logout,
        canDeactivate: [LogoutDeactivate]
    }]
}, {
    path: 'App2',
    component: App2
